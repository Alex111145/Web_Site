...
export const listProyek = [
  {
    id: 1,
    image: Proyek1,
    title: "Solar Panel Detection (DINO/NVIDIA)",
    subtitle: "A Computer Vision project using advanced AI models...",
    fullDescription: "An advanced computer vision project focused on analyzing and detecting solar panels using state-of-the-art foundational models like DINO v2. Leveraging NVIDIA technologies, this system aims to automate the inspection and anomaly detection processes for solar energy infrastructure.",
    borderColor: "#F59E0B",
...
// --- SEZIONE CERTIFICATIONS (Ordinate: Più recente -> Più vecchia) ---
export const listCertifications = [
  ...
  { id: 7, gambar: Cert1, nama: "Coding Challenge", ket: "Achievement / Award", anno: "2023", dad: "300" },
];