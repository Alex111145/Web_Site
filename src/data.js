...
export const listProyek = [
  {
    ...
    fullDescription: "This project implements a high-precision instance segmentation framework for solar energy monitoring. Utilizing aerial datasets acquired via UAVs (Unmanned Aerial Vehicles), we deployed the MaskDINO foundational model to automate the detection and pixel-level segmentation of solar panels, enabling granular anomaly analysis and health assessment of large-scale photovoltaic arrays.",
    anno: "Present",
    borderColor: "#F59E0B",
