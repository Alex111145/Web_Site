          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I'm Alessio Gervasini, a Computer Science student at the University of Insubria, passionate about Artificial Intelligence, Machine Learning, and Cybersecurity. I focus on image recognition, object detection, and pattern analysis, while also exploring network security and digital asset protection. With 4 completed projects and multiple certifications  including Google Cloud ML Engineer, AWS Machine Learning, and Docker-Kubernetes."
                   delay={150}
                  animateBy="words"
                  direction="top"
