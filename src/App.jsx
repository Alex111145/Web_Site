      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s text-white">
            ...
            <BlurText text="Passionate about Artificial Intelligence and Cybersecurity. Deeply committed to protecting digital assets and exploring network security." delay={150} animateBy="words" className="mb-6" />
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard name="Alessio Gervasini" title="Machine Learning Specialist" status="Online" avatarUrl="./assets/alessio.png" onContactClick={() => document.getElementById('contact').scrollIntoView({ behavior: 'smooth' })} />
          </div>
        </div>
        ...
        <div className="mt-15 mx-auto w-full max-w-[1600px] rounded-3xl border-[5px] border-violet-500/40 shadow-[0_0_30px_rgba(168,85,247,0.4)] bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] p-8 md:p-12" id="about">
          <div className="flex flex-col items-center justify-center text-center text-white" data-aos="fade-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-10 sm:gap-20 mb-8 w-full">
              ...
              <div><h1 className="text-4xl md:text-5xl mb-2 font-bold">3<span className="text-violet-500">+</span></h1><p className="text-gray-400">Years of Experience</p></div>
            </div>
